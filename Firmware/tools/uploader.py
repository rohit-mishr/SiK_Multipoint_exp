...
if __name__ == '__main__':
    ...
    # glob.glob cannot resolve Windows device paths like \\.\COM10 or plain COM10.
    # Only use glob when the port string contains actual wildcard characters.
    if any(c in args.port for c in ('*', '?', '[')):
